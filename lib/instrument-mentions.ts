...
export const EXPLICIT_INSTRUMENTS: readonly InstrumentSpec[] = [
  ...
  { instrument: "NFLX", aliases: ["NFLX", "NETFLIX"] },
  ...
  { instrument: "SOXX", aliases: ["SOXX", "SEMICONDUCTOR ETF"] },
  { instrument: "SMH", aliases: ["SMH", "SEMICONDUCTORS", "SEMIS"] },
  ...
  { instrument: "NIKKEI", aliases: ["NIKKEI", "NI225", "JP225", "JAPAN STOCKS", "JAPANESE STOCKS"] },
  { instrument: "HSI", aliases: ["HSI", "HANG SENG", "HANG SENG INDEX", "HK50"] },
  ...
  { instrument: "WTI", aliases: ["WTI", "CL1!", "USOIL", "US OIL", "WEST TEXAS INTERMEDIATE"] },
  { instrument: "ULSD", aliases: ["ULSD", "HO1!", "HEATING OIL", "DIESEL", "DISTILLATE"] },
  ...
  { instrument: "US02Y", aliases: ["US02Y", "US 2-YEAR", "2-YEAR YIELD", "2 YEAR YIELD"] },
