...
22. TOP-LEVEL RESEARCH GAP DISCIPLINE: Reader-facing Dossier health is assembled deterministically from packet/source coverage, not from model-generated research wishes. Therefore return research_gaps: [] for analytical missing-data questions. Put ALL analytical refinement needs — including term-premium decomposition, global-sovereign confirmation, dealer positioning, intraday flow, options skew, refinery outage/flow detail, terminal logistics, freight detail, curve/crack detail and higher-frequency decomposition — in investigations[*].missing_evidence and/or research_now. A missing refinement must never inflate the Live/Hybrid top-level health-gap count when the current conclusion is evidence-supported.
